                  ...
                  <div class="table-responsive">
                    <table id="best_seller_data_table" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><img class="cat-thumb" src="assets/img/clients/6.jpg" alt="clients Image"><span
                              class="name">Jens Fashion.</span>
                          </td>
                          <td>
                            <span class="cat">
                ...
                <div class="top-product-table">
                  <div class="table-responsive">
                    <table id="top_product_data_table" class="table">
                      ...
                      <tbody>
                        <tr>
                          <td><img class="cat-thumb" src="assets/img/product/1.jpg" alt="clients Image"><span
                        ...
                        <tr>
                          <td><img class="cat-thumb" src="assets/img/product/2.jpg" alt="clients Image"><span
                        ...
                        <tr>
                          <td><img class="cat-thumb" src="assets/img/product/3.jpg" alt="clients Image"><span
                        ...
                        <tr>
                          <td><img class="cat-thumb" src="assets/img/product/4.jpg" alt="clients Image"><span
                        ...
                        <tr>
                          <td><img class="cat-thumb" src="assets/img/product/5.jpg" alt="clients Image"><span
                        ...
                        <tr>
                          <td><img class="cat-thumb" src="assets/img/product/6.jpg" alt="clients Image"><span
                    ...
                    <table id="recent_order_data_table" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><img class="cat-thumb" src="assets/img/product/7.jpg" alt="clients Image"><span
                              class="name">Head phone</span>
                          </td>
                          <td>Moris Nency</td>
                          <td>$525</td>
                          <td class="paid">Paid</td>
                        ...
                        <tr>
                          ...
                          <td><img class="cat-thumb" src="assets/img/product/8.jpg" alt="clients Image"><span
                              class="name">Camera Dron</span>
                          </td>
                          <td>Wiley Waites</td>
                          <td>$1255</td>
                          <td class="paid">Paid</td>
                        ...
                        <tr>
                          ...
                          <td><img class="cat-thumb" src="assets/img/product/9.jpg" alt="clients Image"><span
                              class="name">Drill machine</span>
                          </td>
                          <td>Sarah Moanees</td>
                          <td>$684</td>
                          <td class="pending">pending</td>
                        ...
                        <tr>
                          ...
                          <td><img class="cat-thumb" src="assets/img/product/10.jpg" alt="clients Image"><span
                              class="name">Camera Dron</span>
                          </td>
                          <td>Anne Ortha</td>
                          <td>$854</td>
              ...
              <div class="cr-card-content">
                ...
                <div class="cr-map-detail">
                  <div class="cr-map-detail">
                    <div class="title">
                      <h5>Revenue</h5>
                      <a href="#" class="visit" title="View all data">view <i class="ri-arrow-right-line"></i></a>
                    </div>
                    <div class="cr-detail-list">
                      ...
                      <div class="progress">
                        <div class="progress-bar bg-secondary" role="progressbar" style="width: 95%" aria-valuenow="95"
                    ...
                    <div class="cr-detail-list">
                      ...
                      <div class="progress">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: 84%" aria-valuenow="84"
                          aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                    <div class="cr-detail-list">
