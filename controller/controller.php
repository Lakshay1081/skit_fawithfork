...
$faculty_joiningReport = mysqli_real_escape_string($conn, isset($_REQUEST['faculty_joiningReport']) ? $_REQUEST['faculty_joiningReport'] : '');
$faculty_offerLetter = mysqli_real_escape_string($conn, isset($_REQUEST['faculty_offerLetter']) ? $_REQUEST['faculty_offerLetter'] : '');
